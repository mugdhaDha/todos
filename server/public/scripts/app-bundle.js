define('app',['exports', 'aurelia-framework', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaAuth) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaAuth.FetchConfig), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.title = 'Todos';
      config.map([{ route: ['', 'home'], moduleId: './modules/home/home', name: 'Home' }, { route: 'todo', moduleId: './modules/list/todo', name: 'Todo' }]);
    };
...
define('modules/auth-config',['exports'], function (exports) {
  'use strict';
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./value-converters/gravatar-url', './value-converters/date-format', './value-converters/done', './value-converters/hide-completed']);
  }
});
define('modules/home/home',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth', '../../resources/data/users', 'aurelia-validation', '../../resources/utils/bootstrap-form-renderer'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth, _users, _aureliaValidation, _bootstrapFormRenderer) {
  'use strict';
  ...
  var Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService, _users.Users, _aureliaValidation.ValidationControllerFactory), _dec(_class = function () {
    ...
    Home.prototype.login = function login() {
      ...
      return this.auth.login(this.email, this.password).then(function (response) {
        ...
        console.log(error);
        console.log("this.email: " + _this.email + "this.pw: " + _this.password);
...
define('modules/list/todo',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth', '../../resources/data/todos', '../../resources/data/users', '../../resources/data/data-services'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth, _todos, _users, _dataServices) {
  'use strict';
  ...
  var Todo = exports.Todo = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService, _todos.Todos, _users.Users, _dataServices.DataServices), _dec(_class = function () {
    function Todo(router, auth, todos, users, data) {
      _classCallCheck(this, Todo);

      this.DATE_FORMAT_TABLE = "MMM DD YYYY";
    ...
    Todo.prototype.refreshTodo = function () {
    ...
    Todo.prototype.newTodo = function newTodo() {
    ...
    Todo.prototype.edit = function edit(index) {
      this.todos.selectTodo(index);
      this.todoSelected = true;
    };
    ...
    Todo.prototype.togglehideCompleted = function togglehideCompleted() {
...
define('resources/data/todos',['exports', 'aurelia-framework', './data-services', 'moment'], function (exports, _aureliaFramework, _dataServices, _moment) {
    ...
    var Todos = exports.Todos = (_dec = (0, _aureliaFramework.inject)(_dataServices.DataServices), _dec(_class = function () {
            ...
            var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(id) {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                url = this.data.TODO_SERVICE + '/usertodos/' + id + '?order=dueDate';
                                _context2.prev = 1;
                                _context2.next = 4;
                            ...
                            case 12:
                                return _context2.abrupt('return', this.todoArray);
        ...
        Todos.prototype.selectTodo = function () {
                            ...
                            case 0:
                                ...
                                if (!index && index != 0) {
                                    this.selectedTodo = {
                                        ...
                                        dueEntered: (0, _moment2.default)(new Date()).format("YYYY-MM-DD")
                                    };
                                } else {
  ...
  var GravatarUrlValueConverter = exports.GravatarUrlValueConverter = function () {
    ...
    GravatarUrlValueConverter.prototype.toView = function toView(email, size) {
      if (email !== undefined) {
        ...
        var size = size || 80;
        var html = '<img class="img-circle" src="http://www.gravatar.com/avatar/' + MD5(email.toLowerCase()) + '.jpg?s=' + size + '"/>';
        return html;
      } else {
